...
/*    public static List<MealTo> friendsAsArray(){
        ...
        List<MealTo> mealsTo = filteredByStreams(Arrays.asList(meals), LocalTime.MIN, LocalTime.MAX, returnCaloriesNorm());
        return mealsTo;
    }*/
public static Collection<Meal> MealToServiceHard() {

    Collection meals = Arrays.asList(
            /* Meal[] meals= */
    ...
    public static int returnCaloriesNorm(){
        return 2000;
    }
